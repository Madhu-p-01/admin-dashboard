...
('cat_001', 'Clothing', 'Fashion and apparel', NOW(), NOW()),
('cat_002', 'Electronics', 'Electronic devices and gadgets', NOW(), NOW()),
('cat_003', 'Books', 'Books and literature', NOW(), NOW()),
('cat_004', 'Home', 'Home and garden products', NOW(), NOW()),
('cat_005', 'Sports', 'Sports and fitness equipment', NOW(), NOW());
...
('prd_001', 'Denim Jacket', 'Classic blue denim jacket', 2499.00, 'INR', 50, 'cat_001', '["https://example.com/denim1.jpg", "https://example.com/denim2.jpg"]', '["S", "M", "L", "XL"]', '["Blue", "Black"]', 4.5, 'active', true, NOW(), NOW()),
('prd_002', 'Cotton T-Shirt', 'Comfortable cotton t-shirt', 899.00, 'INR', 100, 'cat_001', '["https://example.com/tshirt1.jpg"]', '["S", "M", "L", "XL"]', '["White", "Black", "Red", "Blue"]', 4.2, 'active', false, NOW(), NOW()),
('prd_003', 'Smartphone', 'Latest smartphone with advanced features', 25000.00, 'INR', 25, 'cat_002', '["https://example.com/phone1.jpg"]', '["128GB", "256GB"]', '["Black", "White", "Blue"]', 4.8, 'active', true, NOW(), NOW()),
('prd_004', 'Programming Book', 'Complete guide to programming', 599.00, 'INR', 75, 'cat_003', '["https://example.com/book1.jpg"]', '["Paperback"]', '["N/A"]', 4.6, 'active', false, NOW(), NOW()),
('prd_005', 'Yoga Mat', 'Premium quality yoga mat', 1299.00, 'INR', 30, 'cat_005', '["https://example.com/yogamat1.jpg"]', '["Standard"]', '["Purple", "Blue", "Pink"]', 4.3, 'active', false, NOW(), NOW());

-- Sample order items
INSERT INTO order_items (order_item_id, order_id, product_id, quantity, price, created_at) VALUES
('item_001', '750e8400-e29b-41d4-a716-446655440001', 'prd_001', 2, 2499.00, NOW()),
('item_002', '750e8400-e29b-41d4-a716-446655440001', 'prd_002', 1, 899.00, NOW()),
('item_003', '750e8400-e29b-41d4-a716-446655440002', 'prd_001', 1, 2499.00, NOW()),
('item_004', '750e8400-e29b-41d4-a716-446655440003', 'prd_002', 2, 899.00, NOW()),
('item_005', '750e8400-e29b-41d4-a716-446655440004', 'prd_003', 1, 25000.00, NOW()),
('item_006', '750e8400-e29b-41d4-a716-446655440005', 'prd_004', 1, 599.00, NOW()),
('item_007', '750e8400-e29b-41d4-a716-446655440006', 'prd_002', 1, 899.00, NOW()),
('item_008', '750e8400-e29b-41d4-a716-446655440007', 'prd_005', 1, 1299.00, NOW()),
('item_009', '750e8400-e29b-41d4-a716-446655440008', 'prd_003', 1, 25000.00, NOW()),
('item_010', '750e8400-e29b-41d4-a716-446655440009', 'prd_001', 1, 2499.00, NOW()),
('item_011', '750e8400-e29b-41d4-a716-446655440010', 'prd_004', 2, 599.00, NOW());

-- Sample payments
INSERT INTO payments (payment_id, order_id, method, status, transaction_id, amount, created_at) VALUES
('pay_001', '750e8400-e29b-41d4-a716-446655440001', 'UPI', 'paid', 'TXN123456789', 4717.60, NOW()),
('pay_002', '750e8400-e29b-41d4-a716-446655440002', 'Card', 'paid', 'TXN123456790', 2499.00, NOW()),
('pay_003', '750e8400-e29b-41d4-a716-446655440003', 'UPI', 'paid', 'TXN123456791', 1899.50, NOW()),
('pay_004', '750e8400-e29b-41d4-a716-446655440004', 'Card', 'paid', 'TXN123456792', 3200.00, NOW()),
('pay_005', '750e8400-e29b-41d4-a716-446655440005', 'UPI', 'failed', 'TXN123456793', 1550.00, NOW()),
('pay_006', '750e8400-e29b-41d4-a716-446655440006', 'COD', 'pending', NULL, 1850.00, NOW()),
('pay_007', '750e8400-e29b-41d4-a716-446655440007', 'UPI', 'pending', NULL, 2150.00, NOW()),
('pay_008', '750e8400-e29b-41d4-a716-446655440008', 'Card', 'paid', 'TXN123456794', 5500.00, NOW()),
('pay_009', '750e8400-e29b-41d4-a716-446655440009', 'UPI', 'paid', 'TXN123456795', 3200.00, NOW()),
('pay_010', '750e8400-e29b-41d4-a716-446655440010', 'Card', 'paid', 'TXN123456796', 4100.00, NOW());
